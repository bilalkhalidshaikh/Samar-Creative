          ...
          <div className="container">
              ...
              <div className="row">
                  <div className="col-xl-6 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                      <div className="dlab-blog blog-half m-b30">
                          <div className="dlab-media">
                              <Link href="blog-details-3"><img src="images/blog/default/thum1.jpg" alt=""/></Link>
                          </div>
                          <div className="dlab-info">
                              <h5 className="dlab-title">
                                  <Link href="blog-details-3">Vestibulum massa arcu, consectetu  pellentesque scelerisque.</Link>
                              </h5>
                  ...
                  <div className="col-xl-6 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.4s">
                      <div className="dlab-blog blog-half m-b30">
                          <div className="dlab-media">
                          <Link href="blog-details-3"><img src="images/blog/default/thum2.jpg" alt=""/></Link>
                          </div>
                          <div className="dlab-info">
                              <h5 className="dlab-title">
                                  <Link href="blog-details-3">Quisque egestas iaculis felis eget placerat ut pulvinar mi.</Link>
                              </h5>
                              <p>Sed quis sagittis velit. Aliquam velit eros, bibendum ut massa et, consequat laoreet erat nam ac imperdiet.</p>
                              <div className="dlab-meta">
                                  <ul>
                  ...
                  <div className="col-xl-6 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.6s">
                      <div className="dlab-blog blog-half m-b30">
                          <div className="dlab-media">
                              <Link href="blog-details-3"><img src="images/blog/default/thum3.jpg" alt=""/></Link>
                          </div>
                          <div className="dlab-info">
                              <h5 className="dlab-title">
                                  <Link href="blog-details-3">Fusce sem ligula, imperdiet sed nisi sit amet, euismod posuere.</Link>
                              </h5>
                              <p>Sed quis sagittis velit. Aliquam velit eros, bibendum ut massa et, consequat laoreet erat nam ac imperdiet.</p>
                              <div className="dlab-meta">
                                  <ul>
                  ...
                  <div className="col-xl-6 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.8s">
                      <div className="dlab-blog blog-half m-b30">
                          <div className="dlab-media">
                              <Link href="blog-details-3"><img src="images/blog/default/thum4.jpg" alt=""/></Link>
                          </div>
                          <div className="dlab-info">
                              <h5 className="dlab-title">
                                  <Link href="blog-details-3">Donec feugiat mollis nisi in dignissim. Morbi sollicitudin quis.</Link>
                              </h5>
                              <p>Sed quis sagittis velit. Aliquam velit eros, bibendum ut massa et, consequat laoreet erat nam ac imperdiet.</p>
                              <div className="dlab-meta">
                                  <ul>
