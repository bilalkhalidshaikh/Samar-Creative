				...
				<div className="row align-items-center">
					<div className="col-xl-6 col-lg-7 wow fadeInLeft" data-wow-duration="2s" data-wow-delay="0.2s">
						<div className="section-head style-1">
							...
							<h2 className="title">Our Working Process To Help To Boost Your Business</h2>
						</div>
						<div className="section-wraper-one">
							<div className="icon-bx-wraper style-2 left m-b30">
								...
								<div className="icon-content">
									...
									<p>It involves collecting and analyzing information to develop a clear understanding of the problem or opportunity you are trying to address.</p>
								</div>
							</div>
							<div className="icon-bx-wraper style-2 left m-b30">
								...
								<div className="icon-content">
									...
									<p>Developing involves planning the development process, building the product, testing it, and launching and maintaining it.</p>
								</div>
							</div>
							<div className="icon-bx-wraper style-2 left m-b30">
								...
								<div className="icon-content">
									...
									<p>Testing involves defining objectives, conducting tests, documenting and tracking issues, and continuously improving the product</p>
								</div>
							</div>
						</div>
					</div>
