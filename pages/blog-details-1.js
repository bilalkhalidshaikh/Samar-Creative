                      ...
                      <div className="row extra-blog style-1">
                              ...
                              <div className="dlab-blog style-1 bg-white text-center m-b30">
                                  ...
                                  <div className="dlab-info">
                                      <h5 className="dlab-title">
                                          <Link href="/blog-large-right-sidebar">Praesent ut lobortis purus hasellus libero orci, accumsan.</Link>
                                      </h5>
                          ...
                          <div className="col-lg-6 col-md-6">
                              <div className="dlab-blog style-1 bg-white text-center m-b30">
                                  ...
                                  <div className="dlab-info">
                                      <h5 className="dlab-title">
                                          <Link href="/blog-large-right-sidebar">Donec feugiat mollis nisi in dignissim. Morbi sollicitudin.</Link>
                                      </h5>
                                      <p className="m-b0">Pellentesque vel nibh gravida erat interdum lacinia vel in lectus. Sed fermentum  pulvinar.</p>
                                      <div className="dlab-meta meta-bottom">
                                          <ul>
                          ...
                          <div className="comments-area style-1" id="comments">
                              ...
                              <div className="clearfix">
                                  ...
                                  <div className="comment-respond style-1" id="respond">
                                      <h2 className="comment-reply-title" id="reply-title">Leave a Reply <small> <Link
                                          href="#"
                                          style={{"display":"none"}}
                                          id="cancel-comment-reply-link"
                                          rel="nofollow">Cancel reply</Link> </small> </h2>
                          ...
                          <div className="widget recent-posts-entry">
                              ...
                              <div className="widget-post-bx">
                                  <div className="widget-post clearfix">
                                      ...
                                      <div className="dlab-info">
                                          <h4 className="title"><Link href="/blog-large-right-sidebar">Fusce mollis felis quis tristique</Link></h4>
