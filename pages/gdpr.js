            ...
            <div className="dlab-bnr-inr-entry">
                ...
                <nav aria-label="breadcrumb" className="breadcrumb-row">
                    <ul className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">GDPR</li>
                    </ul>
                </nav>
                {/* <!-- Breadcrumb Row End --> */}
            </div>
...
<div className="container">
            ...
            At Digital Smith, we are committed to ensuring the privacy and
            security of the personal data we collect, use, and disclose.
            <br/>
             This
            privacy policy explains how we use and protect your personal data,
            and outlines your rights regarding your personal data. 
            <br/>
            Please read
            this policy carefully to understand how we handle your personal
            data.
            <br />
            <br />
            <br />
            ...
            personal data for marketing purposes, such as to send you
            promotional materials about our products and services.
            <br />
            <br />
            <br />
            ...
            <br/>
             We
            also require our service providers and business partners to take
            ...
            <br/>
            If you have
            any questions or concerns regarding your personal data, please
