        ...
        >
                <div className="item">
                    <div className="dlab-blog style-2 m-b10">
                        ...
                        <Link href="blog-details-2"><img src="images/blog/blog-grid-2/pic1.jpg" alt=""/></Link>
                        </div>
                        <div className="dlab-info">
                            ...
                            <Link href="blog-details-2" className="btn-link style-1">Read More</Link>
                        </div>
                    </div>
                </div>
                <div className="item">
                    <div className="dlab-blog style-2 m-b10">
                        <div className="dlab-media rounded-md">
                        <Link href="blog-details-2"><img src="images/blog/blog-grid-2/pic2.jpg" alt=""/></Link>
                        </div>
                        <div className="dlab-info">
                            <div className="dlab-meta">
                                <ul>
